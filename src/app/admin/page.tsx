  ...
  return (
    <div className="mx-auto max-w-6xl">
      ...
      <div className="mt-8 flex flex-wrap gap-4">
        ...
        <Link href="/admin/site-settings" className="card flex items-center gap-3 p-4 transition hover:shadow-lg">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-slate-100">
            <svg className="h-5 w-5 text-slate-600" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          ...
          <div>
            <p className="font-semibold text-slate-900">Настройки сайта</p>
            <p className="text-xs text-slate-500">Яндекс Метрика, код в head</p>
          </div>
        </Link>
      </div>
    </div>
