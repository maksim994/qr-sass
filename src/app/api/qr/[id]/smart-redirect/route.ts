...
export async function PATCH(request: Request, context: RouteContext) {
  ...
  try {
    ...
    if (qr.kind !== "DYNAMIC" || qr.contentType !== "URL") {
      return apiError(MSG.SMART_REDIRECT_DYNAMIC_ONLY, "BAD_REQUEST", 400, undefined, requestId);
    }
    ...
    return apiError(MSG.COULD_NOT_UPDATE_SMART_REDIRECT, "INTERNAL_ERROR", 500, undefined, requestId);
  }
}
